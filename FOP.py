...
IGNORE = ("CC-BY-SA.txt", "easytest.txt", "GPL.txt", "MPL.txt",
          ...
          "easylist_cookie_specific_uBO.txt", "fanboy_annoyance_specific_uBO.txt", "fanboy_newsletter_specific_uBO.txt", "fanboy_notifications_specific_uBO.txt", "fanboy_social_specific_uBO.txt", "fanboy_newsletter_shopping_specific_uBO.txt", "fanboy_agegate_specific_uBO.txt", "config-clean2.json", "config-clean.json", "config-clean.json.txt", "config-clean2.json.txt", "config-clean2.txt", "config-clean.txt", "cleaned-domains.txt", "youtube-autodubbed.txt")
